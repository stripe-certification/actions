...
(async () => {
  try {
    ...
    if (!rubricFile) {
      core.error('This action needs a Rubric file to run. Please ensure that this file is present.');
    }
    if (!currentDetails) {
    ...
    if (!testResultFile && skipTestLabelApplied != 'true') {
      core.error('This action needs the test results file to generate the feedback. Pls ensure that the test result file has been successfully generated by the test suite.');
    }
